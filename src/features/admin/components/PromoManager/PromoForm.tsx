    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="space-y-4">
          ...
          <FormField label="Tipo de promoción" htmlFor="type">
            <select
              id="type"
              className="mt-1 block w-full border border-gray-300 rounded px-3 py-2"
              value={type || ''}
          ...
          {type === PromoType.DESCUENTO && (
            <FormField label="Plato asociado" htmlFor="dish_id" error={errors.dishId}>
              <select
                id="dish_id"
                className="mt-1 block w-full border border-gray-300 rounded px-3 py-2"
                value={dishId}
          ...
          <FormField label="Precio promocional" htmlFor="price">
            <input
              id="price"
              type="number"
              min={0}
        ...
        <div className="space-y-4">
          <FormField label="Fecha de inicio" htmlFor="start_date" error={errors.startDate} required>
            <input
              id="start_date"
              type="date"
              className="mt-1 block w-full border border-gray-300 rounded px-3 py-2"
          ...
          <FormField label="Fecha de fin" htmlFor="end_date" error={errors.endDate}>
            <input
              id="end_date"
              type="date"
              className="mt-1 block w-full border border-gray-300 rounded px-3 py-2"
          ...
          <FormField label="URL de imagen" htmlFor="image_url">
            <input
              id="image_url"
              type="url"
              className="mt-1 block w-full border border-gray-300 rounded px-3 py-2"
